...
class TempleRequestHistoryAddAdapter(private var mTempleList: ArrayList<Temple>) :
    RecyclerView.Adapter<TempleRequestHistoryAddAdapter.TempleRequestHistoryAddHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TempleRequestHistoryAddAdapter.TempleRequestHistoryAddHolder {
        val view =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.item_temple_list_with_label, parent, false)
        return TempleRequestHistoryAddHolder(view)
    }
    ...
    override fun onBindViewHolder(
        holder: TempleRequestHistoryAddAdapter.TempleRequestHistoryAddHolder,
        position: Int
    ) {
...
//        }
    ...
    inner class TempleRequestHistoryAddHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
