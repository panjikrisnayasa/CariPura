...
class TempleRequestHistoryEditAdapter(private var mTempleList: ArrayList<Temple>) :
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TempleRequestHistoryEditAdapter.TempleRequestHistoryEditHolder {
        val view =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.item_temple_list_with_label, parent, false)
        return TempleRequestHistoryEditHolder(view)
    }
    ...
    override fun onBindViewHolder(
        holder: TempleRequestHistoryEditAdapter.TempleRequestHistoryEditHolder,
        position: Int
    ) {
