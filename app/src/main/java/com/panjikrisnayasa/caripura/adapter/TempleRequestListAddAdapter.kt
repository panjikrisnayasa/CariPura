...
import com.panjikrisnayasa.caripura.view.TempleRequestDetailAddActivity

class TempleRequestListAddAdapter(private var mTempleList: ArrayList<Temple>) :
    RecyclerView.Adapter<TempleRequestListAddAdapter.TempleRequestListAddHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TempleRequestListAddAdapter.TempleRequestListAddHolder {
        val view =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.item_temple_list_with_label, parent, false)
        return TempleRequestListAddHolder(view)
    }
    ...
    override fun onBindViewHolder(
        holder: TempleRequestListAddAdapter.TempleRequestListAddHolder,
        position: Int
    ) {
    ...
    inner class TempleRequestListAddHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
