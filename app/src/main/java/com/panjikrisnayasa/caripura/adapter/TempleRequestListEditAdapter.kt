...
import com.panjikrisnayasa.caripura.view.TempleRequestDetailEditActivity
...
class TempleRequestListEditAdapter(private var mTempleList: ArrayList<Temple>) :
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TempleRequestListEditAdapter.TempleRequestListEditHolder {
        val view =
    ...
    override fun onBindViewHolder(
        holder: TempleRequestListEditAdapter.TempleRequestListEditHolder,
        position: Int
    ) {
