...
import com.panjikrisnayasa.caripura.view.contributor.MyTempleDetailApprovedActivity

class ContributorMyTempleListApprovedAdapter(private var mTempleList: ArrayList<Temple>) :
    RecyclerView.Adapter<ContributorMyTempleListApprovedAdapter.ContributorMyTempleListApprovedHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ContributorMyTempleListApprovedHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_temple_list, parent, false)
        return ContributorMyTempleListApprovedHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: ContributorMyTempleListApprovedHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(it.context, MyTempleDetailApprovedActivity::class.java)
            it.context.startActivity(intent)
        }
    }

    inner class ContributorMyTempleListApprovedHolder(itemView: View) :
