...
class MyTempleRequestHistoryEditAdapter(private var mTempleList: ArrayList<Temple>) :
    RecyclerView.Adapter<MyTempleRequestHistoryEditAdapter.MyTempleRequestHistoryEditHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): MyTempleRequestHistoryEditHolder {
        val view =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.item_temple_list_with_label, parent, false)
        return MyTempleRequestHistoryEditHolder(view)
    }
    ...
    override fun onBindViewHolder(
        holder: MyTempleRequestHistoryEditHolder,
        position: Int
    ) {
    ...
    inner class MyTempleRequestHistoryEditHolder(itemView: View) :
