...
import com.panjikrisnayasa.caripura.adapter.TempleRequestHistoryViewPagerAdapter
...
class TempleRequestHistoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view_pager_temple_request_history.adapter =
            TempleRequestHistoryViewPagerAdapter(supportFragmentManager, applicationContext)
